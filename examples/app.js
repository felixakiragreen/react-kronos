      ...
      <div style={style.app}>
        <div style={style.page}>
          <header style={style.header}>
            <div>
              <h1 style={{ margin: 0 }}>React Kronos 1.6.0</h1>
              <span style={style.tagline}>
            ...
            <div style={style.icon}>
              <a
                className="icon-link"
                href="https://www.npmjs.com/package/react-kronos"
              >
                {npm}
              </a>
              <a
                className="icon-link"
                href="https://github.com/dubert/react-kronos"
              >
                {github}
              </a>
            </div>
          ...
          <main style={style.main}>
            ...
            <div className="kronos">
              <button
                ...
                onClick={::this.onClickButtonUncontrolled}
              >
                Toggle Visibility
              </button>
              <Kronos
            ...
            <div className="kronos">
              <button
                className="toggle-button"
                onClick={::this.onClickButtonControlled}
              >
                Toggle Visibility
              </button>
              <Kronos
